...
SHELL_SSH_CHAR=" "
SHELL_THEME_PROMPT_COLOR=#TERMPRIMARY
SHELL_THEME_PROMPT_COLOR_SUDO=#TERMCONTRAST
...
SCM_THEME_PROMPT_DIRTY_COLOR=#TERMCONTRAST
SCM_THEME_PROMPT_STAGED_COLOR=#TERMPRIMARY
SCM_THEME_PROMPT_UNSTAGED_COLOR=#TERMPRIMARY
